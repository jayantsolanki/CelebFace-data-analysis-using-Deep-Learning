...
train_images_labels_mat = np.zeros((20000, 2), dtype=np.uint8)
train_images_labels_mat[np.arange(20000), train_images_labels.T] = 1
...
x = tf.placeholder(tf.float32, shape = [None, 2475*3]) 
